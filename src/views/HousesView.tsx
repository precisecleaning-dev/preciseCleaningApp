...
export default function HousesView({ onOpenMenu, properties, setProperties, currentUser, activeRole, isSuperAdmin, roles = [], viewMode = 'table', houseToOpenDetail, clearHouseToOpenDetail, houseToOpenEdit, clearHouseToOpenEdit, renderMode = 'full' }: HousesViewProps) {
